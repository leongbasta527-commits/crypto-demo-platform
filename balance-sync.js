    ...
    try{
      ...
      for(const row of rows){
        ...
        try{
          ...
          // Withdrawal balances are server-owned. Never debit or refund
          // from a browser status poll: the server may already have done so,
          ...
          // A legacy applied flag must not cause any future browser credit.
